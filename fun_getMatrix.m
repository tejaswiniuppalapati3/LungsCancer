function [c_matrix,Result,RefereceResult]= fun_getMatrix(actual,predict,Display)
            ...
            class_list2=grp2idx(class_list);
            
            %Calculate conufsion for all classes
            for i=1:n_class
                class_ref{i,1}=strcat('class',num2str(i),'==>',num2str(class_list2(i)));
                for j=1:n_class
